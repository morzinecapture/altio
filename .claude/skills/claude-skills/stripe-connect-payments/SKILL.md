...
const paymentIntent = await stripe.paymentIntents.create({
  ...
  application_fee_amount: Math.round(agreedPrice * commissionRate * 100),
  transfer_data: {
...
- Commission Altio configurable par type de service dans la table `commission_rates`
