...
const styles = StyleSheet.create({
  ...
  profileInfo: { flex: 1 },
  profileName: { fontFamily: 'Inter_700Bold', fontSize: 16, color: '#1E3A5F' },
  ...
  menuLabel: { flex: 1, fontFamily: 'Inter_500Medium', fontSize: 15, color: '#1E3A5F' },
  ...
  auditBody: { flex: 1 },
  auditAction: { fontFamily: 'Inter_500Medium', fontSize: 14, color: '#1E3A5F' },
  ...
  logoutText: { fontFamily: 'Inter_600SemiBold', fontSize: 15, color: COLORS.urgency },
});
